...
import kotlinx.android.synthetic.main.activity_shape_game.*

class ShapeGameActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionsList = ShapeConstants.getShapeQuestions()
    ...
    private fun setQuestion(){
        ...
        shapeQuestion.text = question.question
        shapeImg.setImageResource(question.image)
            ...
            R.id.submitBtn ->{
                if (mSelectedOptionPosition == 0){
                    ...
                    when {
                        ...
                        intent.putExtra(ShapeConstants.CORRECT_ANSWERS, mCorrectAnswers)
                        intent.putExtra(ShapeConstants.TOTAL_QUESTIONS, mQuestionsList!!.size)
                        startActivity(intent)
                        finish()
                    }
                    }
