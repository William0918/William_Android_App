...
import kotlinx.android.synthetic.main.activity_vehicle_game.*

class VehicleGameActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_vehicle_game)

        window.decorView.systemUiVisibility = View.SYSTEM_UI_FLAG_FULLSCREEN


        mQuestionsList = VehicleConstants.getVehicleQuestions()
    ...
    private fun setQuestion(){
        ...
        vehicleQuestion.text = question.question
        vehicleImg.setImageResource(question.image)
            ...
            R.id.submitBtn ->{
                if (mSelectedOptionPosition == 0){
                    ...
                    when {
                        ...
                        intent.putExtra(VehicleConstants.CORRECT_ANSWERS, mCorrectAnswers)
                        intent.putExtra(VehicleConstants.TOTAL_QUESTIONS, mQuestionsList!!.size)
                        startActivity(intent)
                        finish()
                    }
                    }
